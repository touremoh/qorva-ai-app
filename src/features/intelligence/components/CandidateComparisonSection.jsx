        ...
        <Box>
            ...
            {jobPost?.title && (
                <Box sx={{
                    ...
                    <WorkOutlineOutlinedIcon sx={{ fontSize: tokens.iconSize.sm, color: ACCENT, mt: 0.15, flexShrink: 0 }} />
                    <Box sx={{ minWidth: 0 }}>
                        <Typography sx={{ fontSize: tokens.fontSize.caption, fontWeight: 700, color: ACCENT, mb: 0.4 }}>
                            ...
                            <Box sx={{ display: 'flex', flexWrap: 'wrap', gap: 0.4 }}>
                                {jobPost.requiredSkills.map((s, i) => (
                                    <Chip key={i} label={s} size="small" sx={{
                                        fontSize: tokens.fontSize.micro, height: 16,
                    ...
                    return (
                        ...
                        >
                            ...
                            <Box sx={{ display: 'flex', gap: 1, alignItems: 'flex-start' }}>
                                <Avatar sx={{ width: 34, height: 34, fontSize: tokens.fontSize.caption, fontWeight: 700, backgroundColor: ACCENT, color: tokens.ink.inverse, flexShrink: 0 }}>
                                    {getInitials(c.name)}
                                </Avatar>
                                <Box sx={{ minWidth: 0 }}>
                                    <Typography sx={{ fontSize: tokens.fontSize.body2, fontWeight: 700, color: tokens.ink.strong, lineHeight: 1.2 }}>
                                        {c.name}
                                    </Typography>
                                    {c.currentRole && (
                                        <Typography sx={{ fontSize: tokens.fontSize.caption, color: tokens.ink.muted, mt: 0.2 }}>
                                            {c.currentRole}
                                        </Typography>
                                    )}
                                </Box>
                            ...
                            <Box sx={{ display: 'flex', flexWrap: 'wrap', gap: 0.5 }}>
                                {details.yearsOfExperience != null && (
                                    <Chip label={`${details.yearsOfExperience} ${t('insight.comparison.yearsExperience')}`} size="small" sx={{
                                        fontSize: tokens.fontSize.micro, height: 18, fontWeight: 600,
                                        backgroundColor: 'rgba(8,145,178,0.08)', color: ACCENT,
                                ...
                                {c.seniorityLevel && (
                                    <Chip
                                        ...
                                        size="small"
                                        sx={{ fontSize: tokens.fontSize.micro, height: 18, fontWeight: 600, backgroundColor: 'rgba(99,102,241,0.08)', color: tokens.status.accent.main, border: '1px solid rgba(99,102,241,0.2)', '& .MuiChip-label': { px: 0.75 } }}
                                    />
                                )}
                                {details.skillDepth && (
                                    <Chip
                                        ...
                                        size="small"
                                        sx={{ fontSize: tokens.fontSize.micro, height: 18, fontWeight: 600, backgroundColor: tokens.surface.muted, color: tokens.ink.soft, border: `1px solid ${tokens.line.main}`, '& .MuiChip-label': { px: 0.75 } }}
                                    />
                                )}
                            ...
                            {details.certifications?.length > 0 && (
                                <Typography sx={{ fontSize: tokens.fontSize.caption, color: tokens.ink.muted, lineHeight: 1.5 }}>
                ...
                <Box sx={{ mt: 1.25, pt: 1.25, borderTop: `1px solid ${tokens.surface.muted}` }}>
                    ...
                    <Box sx={{ display: 'flex', flexWrap: 'wrap', gap: 0.4 }}>
                        {commonSkills.map((s, i) => (
                            <Chip key={i} label={s} size="small" sx={{
                                fontSize: tokens.fontSize.micro, height: 18,
