	...
	return (
		...
		<Paper elevation={0} sx={{ border: `1px solid ${tokens.line.main}`, borderRadius: 2.5, overflow: 'hidden' }}>
			...
			<Box sx={{ px: { xs: 2, md: 3 }, py: 2.5, display: 'flex', alignItems: 'center', gap: 2, flexWrap: 'wrap' }}>
				<Avatar sx={{
					width: 60, height: 60, fontSize: tokens.fontSize.lg, fontWeight: 700,
				...
				<Box sx={{ flex: 1, minWidth: 0 }}>
					<Typography sx={{ fontWeight: 700, fontSize: tokens.fontSize.lg, color: tokens.ink.strong, lineHeight: 1.3 }}>
						{fullName}
					</Typography>
				...
				<Box sx={{ display: 'flex', alignItems: 'center', gap: 1, flexShrink: 0 }}>
					<TranslateOutlinedIcon sx={{ fontSize: tokens.iconSize.md, color: tokens.ink.subtle }} />
					<LanguageSwitcher />
				</Box>
			</Box>
		</Paper>
