...
const PLAN_FEATURES = {
	Starter: [
		...
		{ labelKey: 'pricing.starter.cvs', included: true },
		{ labelKey: 'pricing.analytics.advanced', included: true },
		{ labelKey: 'pricing.support.priority8h', included: true },
		{ labelKey: 'pricing.features.aiResumeChat', included: false },
		{ labelKey: 'pricing.features.accountManager', included: false },
		{ labelKey: 'pricing.features.sla', included: false },
	],
	Pro: [
		{ labelKey: 'pricing.features.freeTrial', included: true },
		{ labelKey: 'pricing.professional.cvs', included: true },
		{ labelKey: 'pricing.analytics.advanced', included: true },
		{ labelKey: 'pricing.support.priority8h', included: true },
		{ labelKey: 'pricing.features.aiResumeChat', included: true },
		{ labelKey: 'pricing.features.accountManager', included: false },
		{ labelKey: 'pricing.features.sla', included: false },
	],
	Scale: [
		{ labelKey: 'pricing.features.freeTrial', included: true },
		{ labelKey: 'pricing.enterprise.cvs', included: true },
		{ labelKey: 'pricing.analytics.advanced', included: true },
		{ labelKey: 'pricing.support.priority4h', included: true },
		{ labelKey: 'pricing.features.aiResumeChat', included: true },
